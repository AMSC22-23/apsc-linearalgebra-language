...
as for efficiency reasons, the split is not called automatically at every single changes.
...
Please refer to \href{https://github.com/feelpp/docker/issues/26}{\texttt{ this}}.\hypertarget{index_autotoc_md5}{}\doxysection{$<$tt$>$apsc\+::\+Linear\+Algebra\+::\+Language$<$/tt$>$}\label{index_autotoc_md5}
Now let\textquotesingle{}s navigate inside this namespace to understand how the language is built.\hypertarget{index_autotoc_md6}{}\doxysubsection{$<$tt$>$apsc\+::\+Linear\+Algebra\+::\+Language\+::\+Full\+Matrix$<$/tt$>$}\label{index_autotoc_md6}
...
More specific information can be found inside the source file.\hypertarget{index_autotoc_md7}{}\doxysubsection{$<$tt$>$apsc\+::\+Linear\+Algebra\+::\+Language\+::\+Sparse\+Matrix$<$/tt$>$}\label{index_autotoc_md7}
...
Below some benchmarks can be found by using different {\ttfamily epsilon} values and the G\+M\+R\+ES algorithm\+:

{\ttfamily orsirr\+\_\+1} \tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Epsilon }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ G\+M\+R\+ES  }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
